...
import {
    ...
    findParent,
    findFirst
} from '../src/ast/astWalker';

import { IdentifierNode, SelectNode, Program } from '../src/ast/types';
...
describe('AST Walker', () => {
    ...
    test('collectNodes collects identifiers', () => {
        ...
        const ids = collectNodes(
            ast,
            (n): n is IdentifierNode => n.type === 'Identifier'
        );
    ...
    test('collectNodes collects select statements', () => {
        ...
        const selects = collectNodes(
            ast,
            (n): n is SelectNode => n.type === 'SelectStatement'
        );
