...
describe('T-SQL Parser - CREATE INDEX', () => {
    describe('basic forms', () => {
        test('simple index', () => {
            ...
            expect(stmt.name)
                .toBe('ix_Employee_LastName');

            expect(stmt.table.name)
                .toBe('dbo.Employee');
        });
    ...
    describe('index columns', () => {
        ...
        test('composite index with mixed directions', () => {
            ...
            expect(stmt.columns[1].name)
                .toBe('OrderDate');

            expect(stmt.columns[1].direction)
                .toBe('DESC');
        });
    ...
    describe('WITH options', () => {
        test('single option ONLINE = ON', () => {
            ...
            expect(stmt.options[0].name)
                .toBe('ONLINE');

            expect(stmt.options[0].value)
                .toBe('ON');
        });
        ...
        test('multiple options', () => {
            ...
            expect(
                stmt.options.map((o: any) => o.value)
            ).toEqual([
                'ON',
                '90'
            ]);
