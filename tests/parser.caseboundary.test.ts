...
describe('T-SQL Parser - CASE / IF Integration & Recoverability', () => {
    ...
    describe('Simple CASE', () => {
        ...
        test('simple CASE assignment', () => {
            ...
            const caseExpr =
                col.expression.right;

            expect(caseExpr.type)
                .toBe('CaseExpression');

            expect(caseExpr.input)
                .toBeDefined();
