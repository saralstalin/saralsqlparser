...
describe('T-SQL quirky syntax in multi-statement scripts', () => {
    const cases: QuirkyCase[] = [
        ...
        },
        {
            ...
            statement: 'UPDATE t SET t.Name = s.Name FROM dbo.Target t WITH (UPDLOCK) INNER JOIN dbo.Source s ON t.Id = s.Id;',
    ...
    test.each(cases)('$name parses cleanly beside neighboring statements', ({ statement, expectedType }) => {
