...
export const select = (sql: string) =>
    parseOne<SelectNode>(sql);

export const insert = (sql: string) =>
    parseOne<InsertNode>(sql);

export const update = (sql: string) =>
    parseOne<UpdateNode>(sql);

export const del = (sql: string) =>
    parseOne<DeleteNode>(sql);

export const declareStmt = (sql: string) =>
    parseOne<DeclareNode>(sql);

export const setStmt = (sql: string) =>
    parseOne<SetNode>(sql);

export const createStmt = (sql: string) =>
    parseOne<CreateNode>(sql);

export const dropStmt = (sql: string) =>
    parseOne<DropNode>(sql);

export const ifStmt = (sql: string) =>
    parseOne<IfNode>(sql);

export const blockStmt = (sql: string) =>
    parseOne<BlockNode>(sql);
...
export function toSql(expr: any): string {
    ...
    switch (expr.type) {
        ...
        case 'Identifier':
            return expr.tablePrefix
                ? `${expr.tablePrefix}.${expr.name}`
                : expr.name;
